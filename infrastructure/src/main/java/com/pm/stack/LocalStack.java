...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "z8CGu3RL4Y1Tq6FDmMJhBgebQRrjwU69EgKqJjtlSMe"));
        ...
        FargateService patientService = createFargateService("PatientService",
                ...
                patientServiceDb,
                Map.of(
                        //because local stack do not implement ecs cloud discovery so we use this port
    ...
    private Cluster createEcsCluster(){
        return Cluster.Builder.create(this, "PatientManagementCluster")
                .vpc(vpc)
                //this allows #ms for service discovery
    ...
    private FargateService createFargateService(
        ...
        //adding the env variable to conatiner
    ...
    //create gate with applicaation load balancer
